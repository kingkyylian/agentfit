...
Generated: 2026-05-18T16:43:52.845Z
...
| --- | --- | --- | ---: | ---: |
| .cursor/rules/sql-style.mdc | cursor | .cursor/rules | 0 | 0 |
...
| --- | --- | --- | --- |
| command | .cursor/rules/sql-style.mdc | error | No runnable verification command found in instruction files. |

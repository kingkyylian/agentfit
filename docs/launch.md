...
- NPM package: `@kingkyylian/agentfit@0.1.13`.
...
4. Publish the npm CLI package as `@kingkyylian/agentfit@0.1.13`.
5. Push the GitHub repository and create the `v1` Action tag after the npm package is available.
6. Smoke-test the Action with the manual `AgentFit Consumer Smoke` workflow, which uses `kingkyylian/agentfit@v1` and `version: 0.1.13`.
...
- package-local command freshness fixes available in `0.1.13`: https://github.com/kingkyylian/agentfit/issues/8
- npm workspace, `bun x`, `.cursor/rules/*.md`, and recursive workspace command false-positive fixes are available in `0.1.13`: https://github.com/kingkyylian/agentfit/issues/10, https://github.com/kingkyylian/agentfit/issues/11, https://github.com/kingkyylian/agentfit/issues/12, https://github.com/kingkyylian/agentfit/issues/13
